    ...
    <div className="mx-auto flex min-h-[70vh] max-w-2xl flex-col items-center justify-center rounded-2xl border border-gray-100 bg-white px-6 py-10 shadow-sm">
      <div className="max-w-xl text-center">
        ...
        <p className="mt-4 text-base text-gray-600">
          Выберите путь, который подходит вам лучше всего, и сначала войдите или зарегистрируйтесь.
        </p>
      </div>
      ...
      <div className="mt-8 flex w-full flex-col gap-3 sm:max-w-md">
        ...
        <button
          ...
          className="rounded-2xl border-2 border-[#556B2F] px-5 py-4 text-center text-base font-semibold text-[#556B2F] transition hover:bg-[#f7f4ef]"
        >
